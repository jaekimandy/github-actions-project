...
class TestConfig:
    ...
    def test_production_config(self):
        ...
        assert config.CORS_ORIGINS == ['https://devops-demo.com', 'https://www.devops-demo.com']
        assert config.API_RATE_LIMIT == 100
...
class TestConfigFunctions:
    ...
    def test_get_config_invalid(self):
        ...
        assert isinstance(config, DevelopmentConfig)  # Should return default
...
class TestEnvironmentVariables:
    ...
    def test_config_with_env_vars(self):
        ...
        assert config.CACHE_TYPE == 'memcached'
        assert config.API_RATE_LIMIT == 500
